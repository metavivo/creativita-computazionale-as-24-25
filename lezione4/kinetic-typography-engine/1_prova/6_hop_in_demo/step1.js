...
let moveSpeed = 5;
let moveDirection = 0;
let phrase = "Testing, testing. Questo effetto si chiama Hop-In. Ogni parola usa squash e stretch mentre salta sullo schermo. Le parole svaniscono quando atterrano permettendo alle nuove parole di emergere.".split(" ");
let wordIndex = 0;
let rotationAngle = 0;
let rotationSpeed = 0;
