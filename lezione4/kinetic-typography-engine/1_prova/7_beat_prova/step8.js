...
function setup() {
    createCanvas(800, 400); // Aumenta la larghezza del canvas
    ...
    textObj2 = { x: width * 0.6, y: targetY, startY: targetY, hopStartTimeElastic: null, scaleY: 1 }; // Posiziona a destra
...
function draw() {
 ...
 // DISEGNO DELLA SECONDA ANIMAZIONE (Tipografia Cinetica)
    ...
    scale(1, textObj2.scaleY); // Manteniamo la scala Y
    textAlign(CENTER, CENTER);
    textSize(32);
